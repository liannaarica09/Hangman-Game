...
var doctorWho = ["Fantastic", "Briliant", "Geranimo", "Rose Tyler", "Mickey Smith", "Jackie Tyler", "Fantastic", "Sarah Jane", "Jack Harkness", "Torchwood", "TARDIS", "Ian", "Barbra", "Susan", "Polly"];
...
var nerdfighteria = ["John Green", "Hank Green", "Nerd", "YouTube", "Dear Hank and John", "tuatara", "Turtles All the Way Down", "Paper Towns", "Looking for Alaska", "Hankler Fish", "spiral", "An Abundance of Kathrines", "An Absolutely Remarkable Thing", "Fault in Our Stars", "Ester Earl", "Hazel", "Aza Holmes", "Maureen Johnson"];
