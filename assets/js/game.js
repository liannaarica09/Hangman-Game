...
var starWars = ["X Wing", "Deathstar", "Luke Skywalker", "Rebel Alliance", "Rogue Squadron", "Leia Organa", "Han Solo", "Chewbacca", "Millennium Falcon", "Curuscant", "Tatooine", "Naboo", "Anakin Skywalker", "Yoda", "Obi Wan Kenobie", "Qui Gon Jinn", "Mace Windu", "lightsaber"];
var starTrek = ["Enterprise", "James", "Tibberious", "Kirk", "Jean Luc", "Picard", "William Riker", "Data", "Deanna Tori", "Worf", "Hikaru Sulu", "Montgomery Scott", "Uhura", "Spock", "Vulcan", "Federation"];
...
var lotr = ["Middle Earth", "Hobbit", "Hobbiton", "Bree", "Rivendell", "Rohan", "Edoras", "Gondor", "Dol Amroth", "Minas Tirith", "Minas Arnor", "Ithilien", "Treebeard", "Aragorn", "Boromir", "Faramir", "Frodo Baggins", "Bilbo Baggins", "Sam Gamgee", "Meridoc Brandybuck", "Perigrin Took", "Eomer", "Eowyn", "Legolas", "Gimli", "Ori", "Dori", "Nori", "Biffur", "Boffur", "Bonbor", "Oin", "Gloin", "Balin", "Dwalin", "Fili", "Kili", "Thorin Okenshild", "Gandalf"];
var marvel = ["Tony Stark", "Iron Man", "James Rhodes", "Rhody", "War Machine", "Iron Patriot", "Pepper Potts", "Rescue", "Ho Yinsen", "Toni Ho", "Justin Hammer", "Captain America", "Union Jack", "Dum Dum Dugan", "Captain Britain", "Shadow Cat", "Black Knight", "Dane Whitman", "Pete Wisdom", "Captain Midlands", "Spitfire", "Excalibur", "Alister Stewart", "Hellcat", "Hawkeye", "Clint Barton", "Black Widow", "Avengers", "Young Avengers", "Asgardian", "Hulkling", "Iron Lad", "Patriot", "Wiccan", "Stature", "Speed", "Scarlet Witch", "Quicksilver", "Victor Mancha", "America Chavez", "Marvel Boy", "Loki", "Thor", "Volstag", "Sif", "Happy Hogan", "Hogan the Grim", "Excelsior", "Stan Lee", "Jack Kirby", "Joe Simon", "Chris Claremont", "Defenders", "Dr Strange", "Sorcerer Supreme", "The Collector", "Agent Phil Coulson", "Galaga", "shawarma", "Maria Hill", "Daisy Johnson", "Quake", "Professor X", "Hulk", "Bruce Banner", "Amadeus Cho", "Patsy Walker", "Tippy Toe", "Steve Rogers", "Bucky", "James Buchanan Barnes", "Winter Soldier", "Peggy Carter", "Hela", "Merlin", "Jessica Jones", "Luke Cage", "Iron Fist", "Daredevil", "Spider Man", "Peter Parker", "Miles Morales", "Wolverine", "Phoenix", "Kitty Pride", "Iceman", "Blink", "Warpath", "Dani Moonstar", "Valkyrie", "Prodigy", "Rogue", "Gambit", "Bullseye", "Thunderbird", "Magneto", "Mangog", "Galactus", "Black Panther", "Wakanda"];
var janeAusten = ["Emma", "Emma Woodhouse", "George Knightley", "John Knightley", "Isabella Knightley", "Pride and Prejudice", "Elizabeth Bennet", "Kitty Bennet", "Jane Bennet", "Bingley", "Darcy", "Sense and Sensibility", "Lizzie Bennet Diaries", "Emma Approved"];
var hamilton = ["Alexander Hamilton", "George Washington", "Thomas Jefferson", "Aaron Burr", "Yorktown", "Virginia", "New York", "Eliza", "Angelica Schuyler", "Philip", "Peggy", "Hercules Mulligan", "John Laurens", "Shot", "America", "immigrants", "write", "Lafayette"];
...
var disney = ["Rapunzel", "Cinderella", "Aurora", "Sleeping Beauty", "Belle", "Lion King", "Simba", "Nala", "Tarzan", "Dalmatian", "Cruela Devill", "Maleficent", "Ariel", "Merida", "Brave", "Tangled", "Flynn Rider", "Woody", "Buzz Lightyear", "Incredibles", "Dumbo", "Snow White", "Mickey", "mouse", "Goofy", "Donald Duck", "Duck Tales", "Tiana", "Scar", "Prince Eric"];
...
function checkGuess(letter, word) {
	...
	console.log(letter + " is as position " + word.indexOf(letter));
...
//if incorrect check if repeat, if not add to list of incorrect letters and display on screen and remove one guess.
